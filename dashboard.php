                                    ...
                                    <div class="col-lg-9 col-sm-8 col-xs-12">
                                       <div class="charts">
                                          <div class="chart chart--dev">
                                             ...
                                             <div class="animated-progress_box h_auto">
                                                <ul class="chart--horiz">
                                                   <li class="chart__bar chart_clr_4" style="width: 45%;">
                                                      <span class="chart__label">
                                                      45% 
                                                      </span>
                                                   </li>
                                                   <li class="chart__bar chart_clr_5" style="width: 60%;">
                                                      <span class="chart__label">
                                                      60% 
                                                      </span>
                                                   </li>
                                                   <li class="chart__bar chart_clr_6" style="width: 70%;">
                                                      <span class="chart__label">
                                                      70% 
                                                      </span>
                                                   </li>
                                    ...
                                    <div class="col-lg-9 col-sm-8 col-xs-12">
                                       <div class="charts">
                                          <div class="chart chart--dev">
                                             ...
                                             <div class="animated-progress_box h_auto">
                                                <ul class="chart--horiz">
                                                   <li class="chart__bar chart_clr_4" style="width: 80%;">
                                                      <span class="chart__label">
                                                      12,204 - 80% 
                                                      </span>
                                                   </li>
                                                   <li class="chart__bar chart_clr_5" style="width: 50%;">
                                                      <span class="chart__label">
                                                      7,200 - 50% 
                                                      </span>
                                                   </li>
                                             ...
                                             <div class="grid_text">
                                                <ul class="chart--horiz">
                                                <li class="chart__bar">
                                                  people reached <img alt="reached" class="w_18px" src="dist/img/reached.png">
                                                </li>
                                                <li class="chart__bar">
                                                   SMS Sent <img alt="sms" class="w_18px" src="dist/img/sms_black.png">
                                                </li>
                                                <li class="chart__bar">
                                                   Email sent <img alt="email" class="w_18px" src="dist/img/email_black.png">
                                                </li>
                                                <ul>
                                             </div>
                                          </div>
